class Lives extends Phaser.Scene{
    ...
    create(){
        ...
        this.add.bitmapText(game.config.width/2 - 80, game.config.height/3, 'pixel_font', 'Player START', 18, Phaser.GameObjects.BitmapText.ALIGN_CENTER).postFX.addGlow('0x2ef699', 1.5, 0)
